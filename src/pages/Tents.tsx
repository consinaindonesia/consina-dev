...
const products = [
  { name: "Stratus 2P", badge: "2P", desc: "Lightweight 2-person shelter, 4-season rated", price: "IDR 2,100,000", img: prodStratus },
  { name: "Stratus 4P", badge: "4P", desc: "Roomy 4-person dome tent for group hikes", price: "IDR 2,750,000", img: prodStratus },
  { name: "Bivouac Solo", badge: "1P", desc: "Ultralight single-person bivvy tent", price: "IDR 980,000", img: prodStratus },
  { name: "Basecamp 6P", badge: "6P+", desc: "Group expedition tent with vestibule", price: "IDR 3,400,000", img: prodStratus },
  { name: "Cirrus 3P", badge: "3P", desc: "3-season backpacking tent with rainfly", price: "IDR 1,650,000", img: prodRaptor },
  { name: "Stormpeak 2P", badge: "2P", desc: "Reinforced alpine tent for high winds", price: "IDR 2,450,000", img: prodRaptor },
  { name: "Vista 4P", badge: "4P", desc: "Panoramic family tent with large windows", price: "IDR 2,950,000", img: prodRaptor },
  { name: "Aegis 1P Pro", badge: "1P", desc: "Pro-grade solo tent for extreme conditions", price: "IDR 1,350,000", img: prodRaptor },
];
...
const capacityFilters = ["All", "1P", "2P", "4P", "6P+"];
const seasonFilters = ["All", "3-season", "4-season"];

export function TentsPage() {
  return (
  ...
  return (
    <section className="border-b border-border bg-muted/40">
      <div className="mx-auto flex max-w-[1280px] flex-col gap-5 px-4 py-6 md:flex-row md:items-center md:gap-10 md:px-8">
        <FilterPills label={t("filters.capacity")} options={capacityFilters} />
        <FilterPills label={t("filters.season")} options={seasonFilters} />
      </div>
    </section>
  );
}
