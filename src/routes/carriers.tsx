...
export const Route = createFileRoute("/carriers")({
  head: () => ({
    meta: [
      { title: "Carriers — Consina | Backpacks for Indonesian Adventures" },
      { name: "description", content: "Shop Consina carriers — backpacks from 35L to 90L built for day hikes, trekking, and expeditions across Indonesia." },
      { property: "og:title", content: "Carriers — Consina" },
...
const products = [
  ...
  { name: "Centurion 80L", capacity: "80L", desc: "Extended-haul carrier for multi-week treks", price: "IDR 2,150,000", img: prodCenturion },
  { name: "Raptor 45L", capacity: "40L", desc: "Day-to-weekend hiking companion", price: "IDR 1,250,000", img: prodRaptor },
  { name: "Raptor 35L", capacity: "40L", desc: "Fast-and-light daypack for single-day summits", price: "IDR 980,000", img: prodRaptor },
  { name: "Trailblazer 50L", capacity: "60L", desc: "Versatile carrier for trekking and travel", price: "IDR 1,450,000", img: prodCenturion },
  { name: "Trailblazer 65L", capacity: "60L", desc: "Balanced load-hauler for week-long routes", price: "IDR 1,650,000", img: prodCenturion },
  { name: "Summit Pro 75L", capacity: "80L", desc: "Alpine expedition pack with ice-axe loops", price: "IDR 2,400,000", img: prodRaptor },
  { name: "Summit Pro 90L", capacity: "100L", desc: "Maximum-capacity hauler for big expeditions", price: "IDR 2,750,000", img: prodRaptor },
];
...
const capacityFilters = ["All", "40L", "60L", "80L", "100L"];
const useFilters = ["All", "Hiking", "Trekking", "Expedition", "Daily"];
    ...
    <section className="relative isolate overflow-hidden">
      ...
      <div className="mx-auto max-w-[1280px] px-4 pb-20 pt-40 md:px-8 md:pb-28 md:pt-48">
        ...
        <p className="mt-5 max-w-2xl text-base leading-relaxed text-white/85 md:text-lg">
          Backpacks built for Indonesian adventures, from day hikes to expeditions.
        </p>
      </div>
    </section>
  );
  ...
  return (
    <section className="border-b border-border bg-muted/40">
      <div className="mx-auto flex max-w-[1280px] flex-col gap-5 px-4 py-6 md:flex-row md:items-center md:gap-10 md:px-8">
        <FilterPills label="Capacity" options={capacityFilters} />
        <FilterPills label="Use" options={useFilters} />
      </div>
    </section>
  );
}
